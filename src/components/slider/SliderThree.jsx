                ...
                <div className="post-metas banner-post-metas post-meta-primary load-anim">
                  <ul className="list-inline">
                    <li>
                      ...
                      {firstPost.source && <div style={{marginTop: '8px', fontSize: '0.9em', color: '#666'}}>Source: {firstPost.source}</div>}
                    </li>
                  </ul>
                </div>
                {/* End of .post-metas */}
                ...
                {postData.slice(1, 8).map((data) => (
                  ...
                  >
                    <div className="media-body">
                      ...
                      {data.source && <p style={{fontSize: '0.85em', color: '#999', marginTop: '8px', marginBottom: '0'}}>Source: {data.source}</p>}
                    </div>
                  </div>
                ))}
